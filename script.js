...
love_btns.forEach(love_btn => {
    love_btn.addEventListener('mousedown', (e) => {
        ...
        love_btn.querySelector('.textt').innerHTML = '<span class="grey-text">Sent to:</span> Ajay';
    ...
    love_btn.addEventListener('mouseup', (e) => {
        ...
        love_btn.querySelector('.textt').innerHTML = 'THANK YOU! <i class="fas fa-redo"></i>';
    });
})
...
const prog = "I AM AJAY.";
let idx = 1;

setInterval(writeText, 100);

function writeText() {
    textt.innerText = prog.slice(0, idx)
